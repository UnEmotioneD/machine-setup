...
| No. | Shortcut        | Action                           |
| --- | --------------- | -------------------------------- |
| 1   | Cmd + Shift + A | Search Everywhere                |
| 2   | Cmd + N         | New file/folder                  |
| 3   | Opt + F7        | Find Usages                      |
| 4   | Shift + F6      | Rename symbol                    |
| 5   | Shift + Shift   | Search Everywhere (double Shift) |
| 6   | Ctrl + Opt + R  | Run Anything                     |
| 7   | Shift + F2      | Go to next problem/error         |
...
| 2   | Alt + 1        | Open Project tool window |
| 3   | Alt + 6        | Open TODO tool window    |
| 4   | Alt + 4        | Open Run tool window     |
| 5   | Alt + Insert   | Generate code            |
| 6   | Ctrl + Alt + L | Reformat code            |
| 7   | Alt + F7       | Find Usages              |
| 8   | Shift + F6     | Rename symbol            |
| 9   | Shift + Shift  | Search Everywhere        |
| 10  | Shift + F10    | Run                      |
| 11  | -              | Go to next problem/error |
...
Settings > Appearance & Behavior > **Appearance** > _Tree Views_ >
`Show indent guides`
...
Settings > Editor > **General** > **Sticky Lines** > `Show sticky lines
while scrolling`
